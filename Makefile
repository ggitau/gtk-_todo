...
mainwindow.o: src/mainwindow.c src/mainwindow.h src/windowbuilder.h src/taskwindow.h 
	$(CC) $(CFLAGS) -c  src/mainwindow.c $(LIBS)
taskwindow.o: src/taskwindow.c src/taskwindow.h src/windowbuilder.h 
	$(CC) $(CFLAGS) -c  src/taskwindow.c $(LIBS)
todoengine.o: src/todoengine.h src/todoengine.c src/taskwindow.h
